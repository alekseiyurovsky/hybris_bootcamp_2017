...
<%@ page import="org.apache.commons.io.input.BoundedInputStream" %>
...
<head>
    ...
    <script language="javascript">
        ...
        textinputs = textinputs != null ? textinputs.substring(0, Math.min(ONE_MEGABYTE, textinputs.length())) : "";
        ...
        {
            Logger.getLogger(this.getClass()).warn("Cannot Create File Temporary ", e);
        }
        ...
        try
        {
            ...
            if(aspell_exe.isAbsolute())
            {
                ...
                try
                {
                    BufferedReader stdInput = new BufferedReader(new InputStreamReader(new BoundedInputStream(p1.getInputStream(), ONE_MEGABYTE)));
                    int index = 0;
                    int text_input_idx = -1;

                    final LineIterator lineIterator = new LineIterator(stdInput);
                    try{
